            ...
            <nav class="bg-white border-b border-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard')">
                                    <ApplicationLogo
                                        class="block w-11 h-9 fill-current text-gray-800"
                                    />
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('dbtest.index')" :active="route().current('dbtest.index')">
                                    DBテスト
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('dbtest.index')" :active="route().current('dbtest.index')">
                            DBテスト
                        </ResponsiveNavLink>
                    </div>
