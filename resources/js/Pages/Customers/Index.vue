...
const searchCustomers = () => {
    Inertia.get(route('customers.index', {searchWord: searchWord.value}));
};
</script>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="container px-5 py-8 mx-auto">
                            ...
                            <div>
                                <input type="text" size="20" v-model="searchWord">
                                <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" @click="searchCustomers">検索</button>
                            </div>
                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <tr v-for="customer in customers.data" :key="customer.id">
                                    ...
                                    <td class="border-b-2 border-gray-200 px-4 py-3 text-lg text-gray-900">{{ customer.tel }}</td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
